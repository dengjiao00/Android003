...
public class DBManager {
    ...
    public static List<String>queryAllCityName(){
     ...
     //   Cursor cursor1 = database.query("info1", null, null, null, null, null,null);
        List<String>cityList = new ArrayList<>();
      //  while (cursor.moveToNext()&&cursor1.moveToNext()) {
        while (cursor.moveToNext()) {
         //   String city = cursor1.getString(cursor1.getColumnIndex("city"))+cursor.getString(cursor.getColumnIndex("city"));
    ...
    /* 存储城市天气要求最多存储8个城市的信息，一旦超过8个城市就不能存储了，获取目前已经存储的数量*/
